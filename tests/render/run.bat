...
pushd "%~dp0..\.."
cl /nologo /std:c++17 /utf-8 /EHsc /W4 /DUNICODE /D_UNICODE tests\render\main.cpp src\BoxModel.cpp src\DesktopItems.cpp src\DesktopSession.cpp src\DesktopHost.cpp src\log.cpp /Fo"build\obj\\" /Fe"build\render-test.exe" /link user32.lib shell32.lib shlwapi.lib gdi32.lib gdiplus.lib ole32.lib oleaut32.lib comctl32.lib
